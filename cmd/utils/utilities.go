...
func JWTCreate(duration int, credentials domains.Credentials, tokenType string) (string, error) {
...
func CheckJWTAccessToken(tokenJWT string) (*domains.CheckJWTResponse, error) {

	resp := &domains.CheckJWTResponse{
		IdPersona:   0,
